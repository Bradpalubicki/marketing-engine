...
- **Errors:** Sentry
- **AI:** claude-sonnet-4-6 (ad copy generation, review responses, nurture copy)
...
# FRESHPAINT deferred to Phase 4 — lib/hipaa.ts covers v1 PHI filtering
...
- [ ] Step 1: Create Search campaign
  ...
  - Bidding: `MANUAL_CPC` $2.00 — upgrade to `TARGET_CPA` after 30 conversions
